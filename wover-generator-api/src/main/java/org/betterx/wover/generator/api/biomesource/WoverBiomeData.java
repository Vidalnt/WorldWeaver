...
public class WoverBiomeData extends BiomeData {
    ...
    public static final MapCodec<WoverBiomeData> CODEC = codec(
        WoverBiomeData::new
    );
    public static final KeyDispatchDataCodec<WoverBiomeData> KEY_CODEC =
    ...
    public WoverBiomeData(
        ...
        this.edgeData =
            edge == null
                ? null
                : BiomeDataRegistry.createKey(edge.identifier());
        this.parentData =
            parent == null
                ? null
                : BiomeDataRegistry.createKey(parent.identifier());
    }

    public static WoverBiomeData of(ResourceKey<Biome> biome) {
        return new WoverBiomeData(
            1.0f,
            biome,
    ...
    public static WoverBiomeData withEdge(
        ResourceKey<Biome> biome,
        ResourceKey<Biome> edge
    ) {
        return new WoverBiomeData(
            1.0f,
            biome,
    ...
    public static WoverBiomeData tempWithEdge(
        ResourceKey<Biome> biome,
        ResourceKey<Biome> edge
    ) {
    ...
    public static <T extends WoverBiomeData> MapCodec<T> codec(
        ...
        WoverBiomeDataImpl.CodecAttributes<T> a =
            new WoverBiomeDataImpl.CodecAttributes<>();
        return codec(
            a.t0,
            a.t1,
            a.t2,
    ...
    public static <T extends WoverBiomeData, P10, P11, P12, P13> MapCodec<
        T
    > codec(
        final RecordCodecBuilder<T, P10> p10,
        final RecordCodecBuilder<T, P11> p11,
    ...
    public static <T extends WoverBiomeData, P10, P11, P12, P13, P14> MapCodec<
        T
    > codec(
        final RecordCodecBuilder<T, P10> p10,
        final RecordCodecBuilder<T, P11> p11,
    ...
    public static @NotNull Registry<BiomeData> getDataRegistry(
        ...
        final Registry<BiomeData> reg =
            acc != null
                ? acc.lookup(BiomeDataRegistry.BIOME_DATA_REGISTRY).orElse(null)
                : null;

        if (reg == null) throw new IllegalStateException(
            "Accessing " +
                forWhat +
                " of " +
                ofBiome +
                " before biome data registry is ready!"
        );
    ...
    public WoverBiomeData findEdgeParent() {
        ...
        final Registry<BiomeData> reg = getDataRegistry(
            "edge parent",
            biomeKey
        );
