...
public abstract class WoverLayoutScreen extends LayoutScreenWithIcon {
    ...
    public static final Identifier WOVER_LOGO_LOCATION = LibWoverUi.C.id(
        "icon.png"
    );
    public static final Identifier WOVER_LOGO_WHITE_LOCATION = LibWoverUi.C.id(
        "icon_bright.png"
    );

    public WoverLayoutScreen(Component component) {
        super(WOVER_LOGO_LOCATION, component);
    }

    public WoverLayoutScreen(@NotNull Runnable onClose, Component component) {
