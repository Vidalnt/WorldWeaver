...
public class FeatureManagerImpl {
    ...
    public static <
        ...
        F extends Feature<C>
    > F register(@NotNull Identifier id, @NotNull F feature) {
    ...
    public static <
        C extends FeatureConfiguration,
        F extends Feature<C>
    > F register(@NotNull ResourceKey<Feature<?>> key, @NotNull F feature) {
    ...
    public static ResourceKey<Feature<?>> createKey(Identifier location) {
        return ResourceKey.create(BuiltInRegistries.FEATURE.key(), location);
    }

    public static final Feature<PlaceFacingBlockConfig> PLACE_BLOCK =
        registerWithLegacy(
    ...
    public static final Feature<NoneFeatureConfiguration> MARK_POSTPROCESSING =
        registerWithLegacy(
    ...
    public static final Feature<SequenceFeatureConfig> SEQUENCE =
        registerWithLegacy(
    ...
    public static final Feature<ConditionFeatureConfig> CONDITION =
        registerWithLegacy(
    ...
    public static final Feature<PillarFeatureConfig> PILLAR =
        registerWithLegacy(
    ...
    public static final Feature<TemplateFeatureConfig> TEMPLATE =
        registerWithLegacy(
