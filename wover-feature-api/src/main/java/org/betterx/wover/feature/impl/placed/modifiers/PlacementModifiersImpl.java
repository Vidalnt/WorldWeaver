...
public class PlacementModifiersImpl {
    ...
    public static final PlacementModifierType<IsNextTo> IS_NEXT_TO =
        registerLegacy("is_next_to", IsNextTo.CODEC);
    public static final PlacementModifierType<NoiseFilter> NOISE_FILTER =
        registerLegacy("noise_filter", NoiseFilter.CODEC);
    ...
    public static final PlacementModifierType<FindInDirection> SOLID_IN_DIR =
        registerLegacy("solid_in_dir", FindInDirection.CODEC);
    ...
    public static final PlacementModifierType<IsBasin> IS_BASIN =
        registerLegacy("is_basin", IsBasin.CODEC);
    ...
    public static final PlacementModifierType<OffsetProvider> OFFSET_PROVIDER =
        register("offset_provider", OffsetProvider.CODEC);
    ...
    public static final PlacementModifierType<InBiome> IN_BIOME =
        registerLegacy("in_biome", InBiome.CODEC);
    ...
    public static final PlacementModifierType<EveryLayer> EVERY_LAYER =
        register("every_layer", EveryLayer.CODEC);

    private static <P extends PlacementModifier> PlacementModifierType<
        P
    > registerLegacy(String path, MapCodec<P> codec) {
    ...
    private static <P extends PlacementModifier> PlacementModifierType<
        P
    > register(String path, MapCodec<P> codec) {
        var id = LibWoverFeature.C.id(path);
        return register(id, codec, false);
    }

    public static <P extends PlacementModifier> PlacementModifierType<
        P
    > register(
        Identifier location,
        MapCodec<P> codec,
    ...
    static {
        if (LegacyHelper.isLegacyEnabled()) {
            final PlacementModifierType<EveryLayer> ON_EVERY_LAYER_LEGACY =
                register(
                    LegacyHelper.BCLIB_CORE.id("on_every_layer"),
                    EveryLayer.CODEC,
                    false
                );
            final PlacementModifierType<EveryLayer> UNDER_EVERY_LAYER_LEGACY =
                register(
