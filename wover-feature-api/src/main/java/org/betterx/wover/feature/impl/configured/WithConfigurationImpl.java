...
public class WithConfigurationImpl<
        F extends Feature<FC>,
        FC extends FeatureConfiguration
    >
    extends FeatureConfiguratorImpl<FC, F>
    implements
        org.betterx.wover.feature.api.configured.configurators.WithConfiguration<
            F,
            FC
        >
{
    ...
    public @NotNull FC createConfiguration() {
        if (feature == null) {
            throwStateError(
                "Feature must be set before creating configuration"
            );
        }
        if (configuration == null) {
            ...
            if (
                NoneFeatureConfiguration.NONE != null
    ...
    > extends ConfiguredFeatureKey<WithConfiguration<F, FC>> {
        ...
        @Override
        public WithConfiguration<F, FC> bootstrap(
