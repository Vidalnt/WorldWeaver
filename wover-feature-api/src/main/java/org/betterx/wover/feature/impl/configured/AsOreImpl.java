...
public class AsOreImpl
    extends FeatureConfiguratorImpl<OreConfiguration, OreFeature>
    implements AsOre
{
    ...
    public AsOre add(RuleTest containedIn, BlockState ore) {
        targetStates.add(OreConfiguration.target(containedIn, ore));
        return this;
    }
