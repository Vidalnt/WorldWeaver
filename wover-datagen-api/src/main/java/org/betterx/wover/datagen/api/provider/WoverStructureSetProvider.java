 ...
 */
public abstract class WoverStructureSetProvider
    extends WoverRegistryContentProvider<StructureSet>
{
     ...
     */
    public WoverStructureSetProvider(@NotNull ModCore modCore) {
    ...
    public WoverStructureSetProvider(
        ...
        super(
            modCore,
            providerId.toString() + " (Structure Sets)",
