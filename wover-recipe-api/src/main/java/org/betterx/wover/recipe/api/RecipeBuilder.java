...
public class RecipeBuilder {
    ...
    public static CraftingRecipeBuilder crafting(
        Identifier id,
        ItemLike output
    ) {
    ...
    public static StonecutterRecipeBuilder stonecutting(
        Identifier id,
        ItemLike output
    ) {
    ...
    public static SmithingRecipeBuilder smithing(
        Identifier id,
        ItemLike output
    ) {
    ...
    public static CookingRecipeBuilder cooking(Identifier id, ItemLike output) {
        return new CookingRecipeBuilderImpl(
            id,
            output,
            false,
            false,
    ...
    public static CookingRecipeBuilder smoker(Identifier id, ItemLike output) {
        return new CookingRecipeBuilderImpl(
            id,
            output,
            false,
    ...
    public static CraftingRecipeBuilder copySmithingTemplate(
        ...
        return copySmithingTemplateBase(
            id,
            costLevel.priceItem,
            outputTemplate
        ).addMaterial('C', centerIngredient);
    }
    ...
    public static class Templates {
        ...
        private static final String[] SHAPE_COLORING = new String[] {
            "###",
            "#I#",
            "###",
        };
        ...
        private static final String[] SHAPE_FIRE_BOWL = new String[] {
            "#I#",
            " # ",
            "L L",
        };
        ...
        private void makeSingleRecipe(
            ...
            String name =
                BuiltInRegistries.BLOCK.getKey(source).getPath() +
                "_" +
                BuiltInRegistries.BLOCK.getKey(result).getPath();

            RecipeBuilder.crafting(C.id(name), result)
                .outputCount(count)
                .group(group)
                .category(category)
                .shape(shape)
        ...
        public void makeWallRecipe(Block source, Block wall) {
            ...
            RecipeBuilder.crafting(C.id(name), wall)
                .outputCount(6)
                .group("walls")
                .shape(SHAPE_3X2)
        ...
        public void makeFireBowlRecipe(
            Block material,
            Block inside,
            Item leg,
            Block result
