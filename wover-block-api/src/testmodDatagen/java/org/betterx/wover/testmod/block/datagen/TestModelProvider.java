...
public class TestModelProvider extends WoverModelProvider {
    ...
    @Override
    protected void bootstrapBlockStateModels(
        WoverBlockModelGenerators blockStateModelGenerator
    ) {
        ...
        blockStateModelGenerator
            .modelFor(Blocks.AMETHYST_BLOCK)
            .createFullBlock(TestBlockRegistry.TEST_BLOCK)
            .createDoor(TestBlockRegistry.TEST_DOOR);

        blockStateModelGenerator.createWall(
            Blocks.AMETHYST_BLOCK,
            TestBlockRegistry.TEST_WALL
        );
    ...
    @Override
    protected void bootstrapItemModels(
