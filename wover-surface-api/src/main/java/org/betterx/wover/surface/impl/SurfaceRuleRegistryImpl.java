...
public class SurfaceRuleRegistryImpl {
    ...
    public static final EventImpl<
        OnBootstrapRegistry<AssignedSurfaceRule>
    > BOOTSTRAP_SURFACE_RULE_REGISTRY = new EventImpl<>(
        "BOOTSTRAP_SURFACE_RULE_REGISTRY"
    );
    ...
    public static void initialize() {
        ...
        WorldLifecycle.BEFORE_CREATING_LEVELS.subscribe(
            SurfaceRuleUtil::injectSurfaceRulesToAllDimensions,
            500
        );
    }
