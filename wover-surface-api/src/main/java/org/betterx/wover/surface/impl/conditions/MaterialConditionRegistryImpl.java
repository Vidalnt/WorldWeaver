...
public class MaterialConditionRegistryImpl {
    ...
    > THRESHOLD_CONDITION = ConditionManager.createKey(
        LibWoverSurface.C.id("threshold_condition")
    );
    public static final ResourceKey<
        MapCodec<? extends SurfaceRules.ConditionSource>
    > VOLUME_THRESHOLD_CONDITION = ConditionManager.createKey(
        LibWoverSurface.C.id("volume_threshold_condition")
    );
    public static final ResourceKey<
        MapCodec<? extends SurfaceRules.ConditionSource>
    > ROUGH_NOISE_CONDITION = ConditionManager.createKey(
        LibWoverSurface.C.id("rough_noise_condition")
    );
    ...
    public static void bootstrap() {
        ...
        register(
            VOLUME_THRESHOLD_CONDITION,
            VolumeThresholdConditionImpl.CODEC,
            true
        );
