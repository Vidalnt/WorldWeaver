...
public class ModelTraitLibrary {
    ...
    public static BlockModelTrait bark(
        ...
        return ClientBlockTraits.MODEL.with((key, block, generator) -> {
            final var textureResource = TextureMapping.getBlockTexture(
                logBlock.get()
            );
            ...
            final var alternatives = Arrays.stream(alternativeTextureSuffixe)
                .map(suffix ->
                    new TextureMapping()
                        .put(
                            TextureSlot.SIDE,
                            textureResource.withSuffix("_side" + suffix)
                        )
                        .put(
                            TextureSlot.END,
                            textureResource.withSuffix("_side" + suffix)
    ...
    public static BlockModelTrait barrel() {
        return ClientBlockTraits.MODEL.with((key, block, generator) -> {
            final PropertyDispatch<
                VariantMutator
            > ROTATIONS_COLUMN_WITH_FACING = PropertyDispatch.modify(
            ...
            MultiVariant multiVariant = generator.vanillaGenerator.plainVariant(
    ...
    public static BlockModelTrait chest(Supplier<Block> planksMaterial) {
        return ClientBlockTraits.MODEL.with((key, chestBlock, generator) -> {
            ...
            generator.vanillaGenerator.createParticleOnlyBlock(
                chestBlock,
                planks
            );
            ...
            final var alternatives = Arrays.stream(alternativeTextureSuffixe)
                .map(suffix ->
                    new TextureMapping()
                        ...
                        .put(
                            TextureSlot.END,
                            textureResource.withSuffix("_top")
                        )
                )
                .toArray(TextureMapping[]::new);
    ...
    public static BlockModelTrait craftingTable(
        Supplier<Block> planksMaterial
    ) {
        return ClientBlockTraits.MODEL.with(
            (key, carftingTableBlock, generator) -> {
    ...
    public static BlockModelTrait hangingSign(
        Supplier<Block> logMaterial,
    ...
    public static BlockModelTrait sign(
        Supplier<Block> logMaterial,
        Supplier<Block> wallSignBlock
    ) {
        return ClientBlockTraits.MODEL.with((key, signBlock, generator) -> {
            generator.createSign(
                logMaterial.get(),
                signBlock,
                wallSignBlock.get()
            );
    ...
    public static BlockModelTrait pressurePlate(
        Supplier<Block> planksMaterial
    ) {
    ...
    public static ItemModelTrait elytra() {
        return ClientItemTraits.MODEL.with((key, elytra, generator) -> {
            ItemModel.Unbaked unbaked = ItemModelUtils.plainModel(
                generator.createFlatItemModel(elytra, ModelTemplates.FLAT_ITEM)
            );
