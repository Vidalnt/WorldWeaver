...
public class RecipeTraitLibrary {
    ...
    protected static void validOrThrow(
        RecipeMaterial sourceMaterial,
        String recipeType,
        String materialType
    ) {
    ...
    public static BlockRecipeTrait planks(RecipeMaterial sourceMaterial) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static BlockRecipeTrait slab(
        RecipeMaterial planksMaterial,
        String group,
        boolean withStonecutter
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static BlockRecipeTrait barrel(
        RecipeMaterial planksMaterial,
    ...
    public static ItemRecipeTrait boat(RecipeMaterial planksMaterial) {
        return ItemRecipeTraitBuilder.BUILDER.with((key, item, context) -> {
            validOrThrow(planksMaterial, "boat", "planks");

            RecipeBuilder.crafting(key.identifier(), item)
                .shape("# #", "###")
                .addMaterial('#', planksMaterial)
                .group("boat")
    ...
    public static BlockRecipeTrait pillar(
        RecipeMaterial slabMaterial,
        @Nullable RecipeMaterial stoneMaterial
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
            ...
            if (stoneMaterial != null) {
                ...
                RecipeBuilder.stonecutting(
                    key.identifier().withPrefix("_stonecutting"),
                    block
                )
                    .input(stoneMaterial)
                    .build(context);
    ...
    public static BlockRecipeTrait button(
        RecipeMaterial planksMaterial,
        String group
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static ItemRecipeTrait chestBoat(
        RecipeMaterial boatMaterial,
        RecipeMaterial chestMaterial
    ) {
        return ItemRecipeTraitBuilder.BUILDER.with((key, item, context) -> {
    ...
    public static BlockRecipeTrait craftingTable(
        RecipeMaterial planksMaterial
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static BlockRecipeTrait hangingSign(
        RecipeMaterial strippedLogMaterial
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static BlockRecipeTrait pressurePlate(
        RecipeMaterial planksMaterial
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static BlockRecipeTrait stairs(
        RecipeMaterial planksMaterial,
        String group,
        boolean withStonecutter
    ) {
    ...
    public static BlockRecipeTrait trapdoor(
        RecipeMaterial planksMaterial,
        String group
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static BlockRecipeTrait woodWall(
        RecipeMaterial planksMaterial,
        RecipeMaterial fenceMaterial
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static BlockRecipeTrait brickSource(
        RecipeMaterial sourceMaterial,
        boolean withStonecutter
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
    ...
    public static BlockRecipeTrait crackedSource(
        RecipeMaterial sourceMaterial,
        boolean withStonecutter
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
            ...
            RecipeBuilder.blasting(key.identifier(), block)
                .input(sourceMaterial)
                .experience(0.1f)
                .cookingTime(200)
                .build(context);
    ...
    public static BlockRecipeTrait stoneCutSource(
        RecipeMaterial sourceMaterial
    ) {
        return BlockRecipeTraitBuilder.BUILDER.with((key, block, context) -> {
