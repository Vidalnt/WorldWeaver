...
public record ToolDescription<I extends Item>(
    I item,
    ...
    private static TagKey<Item>[] getTagKey(ToolSlot slot) {
        return switch (slot) {
            case PICKAXE_SLOT -> new TagKey[] {
                ItemTags.PICKAXES,
                ToolTags.FABRIC_PICKAXES,
            };
            case AXE_SLOT -> new TagKey[] {
                ItemTags.AXES,
                ToolTags.FABRIC_AXES,
            };
            case SHOVEL_SLOT -> new TagKey[] {
                ItemTags.SHOVELS,
                ToolTags.FABRIC_SHOVELS,
            };
            case HOE_SLOT -> new TagKey[] {
                ItemTags.HOES,
                ToolTags.FABRIC_HOES,
            };
            case SWORD_SLOT -> new TagKey[] {
                ItemTags.SWORDS,
                ToolTags.FABRIC_SWORDS,
            };
            case SHEARS_SLOT -> new TagKey[] {
                CommonItemTags.SHEARS,
    ...
    public static <I extends Item> ToolDescription<I> registerTool(
        ...
        var itemDefinition = ItemRegistry.forMod(modCore)
            .defineToolItem(path, definition -> {
        ...
        return new ToolDescription<>(
            (I) itemDefinition.buildAndRegister(),
