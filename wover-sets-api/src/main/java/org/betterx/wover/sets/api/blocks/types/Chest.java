...
public class Chest extends SlotFromDefinition {
    ...
    protected BlockDefinition<?, ?> startBlockDefinition(
        ...
        return registry.defineDefaultBlock(name, def ->
            new ChestBlock(
    ...
    @Override
    protected void addSlotSpecificDefinitions(
        BlockSet<?> set,
        BlockDefinition<?, ?> def
    ) {
    ...
    @Override
    protected BlockModelTrait buildModel(
        BlockSet<?> set,
        BlockTraitLookup blockTraitLookup
    ) {
        return ModelTraitLibrary.chest(set::getBaseBlock);
    }

    @Override
    protected BlockRecipeTrait buildRecipe(
        BlockSet<?> set,
        BlockTraitLookup blockTraitLookup
    ) {
