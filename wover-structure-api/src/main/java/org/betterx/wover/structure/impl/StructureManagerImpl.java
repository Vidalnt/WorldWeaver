...
public class StructureManagerImpl {
    ...
    public static final EventImpl<
        OnBootstrapRegistry<Structure>
    > BOOTSTRAP_STRUCTURES = new EventImpl<>("BOOTSTRAP_STRUCTURES");

    public static final StructureType<
        RandomNbtStructure
    > RANDOM_NBT_STRUCTURE_TYPE = registerType(
    ...
    public static <S extends Structure> @NotNull StructureTypeKey<
        S
    > registerType(
        ...
        final ResourceKey<StructureType<?>> key = ResourceKey.create(
            Registries.STRUCTURE_TYPE,
            location
        );
        @SuppressWarnings("unchecked")
        final StructureType<S> type = (StructureType<S>) Registry.register(
