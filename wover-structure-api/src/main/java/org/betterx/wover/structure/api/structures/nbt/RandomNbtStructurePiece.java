...
public class RandomNbtStructurePiece extends TemplateStructurePiece {
    ...
    public RandomNbtStructurePiece(
        ...
        this(context, compoundTag, compoundTag.getBoolean("A").orElse(false));
    }
    ...
    private static StructurePlaceSettings fromNbt(
        CompoundTag compoundTag,
        boolean keepAir
    ) {
        return settings(
    ...
    protected void addAdditionalSaveData(
        ...
        if (this.keepAir) tag.putBoolean("A", this.keepAir);
    }
