...
public class StructureKeys {
     ...
     * @return The {@link StructureSetKey}
     */
    public static StructurePoolKey pool(Identifier location) {
     ...
     * @return The {@link StructureKey}
     */
    public static <S extends Structure> StructureKey.Jigsaw jigsaw(
        Identifier location
    ) {
     ...
     * @return The {@link StructureKey}
     */
    public static <S extends Structure> StructureKey.RandomNbt randomNbt(
        Identifier location
    ) {
