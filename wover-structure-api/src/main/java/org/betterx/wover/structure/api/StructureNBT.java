...
public class StructureNBT {
    ...
    private BlockPos getCenteredPos(
        ...
        if (structure == null) {
            LibWoverStructure.C.log.error(
                "No structure: " + location.toString()
            );
            return null;
        }

        BlockPos.MutableBlockPos blockpos2 = new BlockPos.MutableBlockPos().set(
            structure.getSize()
        );
